...
class Rectangle:
    ...
    def __str__(self):
        ...
        if self.width == 0 or self.height == 0:
            ...
            rectangle = [Rectangle.print_symbol * self.width for _ in range(self.height)]
            return "\n".join(rectangle)
    ...
    def __del__(self):
        """This method delete an instance of Rectangle and give a message"""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")

    @staticmethod
    def bigger_or_equal(rect_1, rect_2):
        """This static method returns rectangle with biggest area"""
    ...
    def square(cls, size=0):
        """This function that returns a new Rectangle instance with width == height == size"""
